...
define config.name = _("Feel the TEF")
...
define gui.about = _p("""Неймовірна гра, яка допомагає пройти шлях від вступника ТЕФу до становлення студентом.
Адже, як відомо, це стається по закінченню 1 семестру, а до цього ще треба дожити))
""")
...
define config.save_directory = "FeeltheTEF-1673204314"
